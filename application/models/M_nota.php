...
class M_nota extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT id_transaksi, transaction_date, WEEKDAY(transaksi.transaction_date) as hari, produk, qty, harga_satuan, total, pelanggan FROM transaksi WHERE id_transaksi = '$id_transaksi' ")->row_array();
    }
}
