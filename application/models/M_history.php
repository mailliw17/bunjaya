...
class M_history extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT id_transaksi, transaction_date, produk, qty, harga_satuan, total, pelanggan FROM transaksi ORDER BY id_transaksi DESC  ")->result_array();
    }
